  ...
  <head>
   ...
   <h1 style="color:white">Enviar mensaje</h1>
     <div class="container"><div class="formulario">
        <div class="form"><form action="../php/notifi/notificaciones.php" method="post" enctype="multipart/form-data">
            <section id="../php/notificaciones.php" class="contenedor">
                    <table>
                        <tr>
                            <td class="izq">
    ...
    <div class="cerrar"><a href="../Usuario/usuario.php" style="color: green;">anterior</a></div>
  </body>
</html>