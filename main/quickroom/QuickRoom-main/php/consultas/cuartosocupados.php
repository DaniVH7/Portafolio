        ...
        <div class="iniciar">
            ...
            <div class="tabla">
                <?php
                    ...
                    $consultar = "SELECT id_cuarto,id_estudiante,fecha,tiempo_de_renta FROM rentas";

                    if ($resultado = mysqli_query($conectar, $consultar))
                    {
                        printf ("<table><tr><th>Numero de Cuarto</th> <th>Estudiante que lo Ocupa</th> <th>Fecha de la renta</th>
